...
impl Game {
    ...
    fn draw_walls(&self, canvas:&mut graphics::Canvas, ctx: &mut Context,wall_height:f32, line:i32)->GameResult{
    ...
    fn draw_edge(&self, canvas:&mut graphics::Canvas, ctx: &mut Context,wall_height:f32, previous_height:f32, line:i32)->GameResult{
        let y_offset =20.0;
        ...
        if previous_height < wall_height{
            ...
            let end_point = Game::calc_bottom_point(wall_height);
            let start_point = Game::calc_up_point(wall_height);
            let points = &[Vec2::new(x, start_point + y_offset), Vec2::new(x, end_point + y_offset)];
    ...
    fn draw_point(&self, canvas:&mut graphics::Canvas, ctx: &mut Context,x:f32, y:f32)-> GameResult{
    ...
    fn draw_line(&self, canvas:&mut graphics::Canvas, ctx: &mut Context, points:&[Vec2])-> GameResult{
